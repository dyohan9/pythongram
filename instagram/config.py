...
USER_AGENT = (
    "Instagram 9.2.0 Android ({android_version}/{android_release}; 320dpi; "
    "720x1280; {manufacturer}; {model}; armani; qcom; en_US)".format(**DEVICE_SETTINTS)
)
IG_SIG_KEY = "012a54f51c49aa8c5c322416ab1410909add32c966bbaa0fe3dc58ac43fd7ede"
EXPERIMENTS = (
    "ig_android_progressive_jpeg,ig_creation_growth_holdout,ig_android_report_and_hide,"
    ...
    "ig_android_full_people_card_in_user_list,ig_android_post_auto_retry_v7_21,"
    "ig_fbns_push,ig_android_feed_pill,ig_android_profile_link_iab,ig_explore_v3_us_holdout,"
    ...
    "ig_explore_v3,ig_ranking_following,ig_android_pending_request_search_bar,ig_android_feed_ufi_redesign,"
    "ig_android_video_pause_logging_fix,ig_android_default_folder_to_camera,"
    ...
    "ig_android_add_to_last_post,ig_android_direct_public_threads,ig_android_prefetch_venue_in_composer,"
    "ig_android_bigger_share_button,ig_android_dv2_realtime_private_share,ig_android_non_square_first,"
    "ig_android_video_interleaved_v2,ig_android_follow_search_bar,ig_android_last_edits,"
    "ig_android_video_download_logging,ig_android_ads_loop_count_universe,"
    "ig_android_swipeable_filters_blacklist,ig_android_boomerang_layout_white_out_universe,"
    "ig_android_ads_carousel_multi_row_universe,ig_android_mentions_invite_v2,"
